...
> **STATUS (audited 2026-07-28): Tasks 13–22 all implemented.** `web/src/views/` maps 1:1 onto the task split; Dockerfile + docker-compose.yml + plugins/static.js cover T21; e2e/smoke.mjs covers T22's participant-link golden path. Baseline at audit: web 270/270, server 114/114 tests green.
